...
export function PageMain({ children, ...rest }: ComponentProps<"main">) {
  return (
    <main
      id="main"
      tabIndex={-1}
      className="relative z-10 flex flex-1 flex-col overflow-hidden px-4 pb-[var(--nav-h)] focus:outline-hidden focus-visible:ring-2 focus-visible:ring-blue-400/60 md:px-6 md:pb-0"
      {...rest}
    >
      {children}
    </main>
